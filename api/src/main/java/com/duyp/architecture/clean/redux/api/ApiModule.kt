...
import com.duyp.architecture.clean.redux.api.interceptors.ContentTypeInterceptor
import com.duyp.architecture.clean.redux.api.interceptors.PaginationInterceptor
...
object ApiModule {
    ...
    fun provideGson(): Gson {
        return GsonBuilder()
            ...
            .disableHtmlEscaping()
            .setPrettyPrinting()
            .registerTypeAdapter(Date::class.java, GithubDateDeserializer())
            .create()
    }
